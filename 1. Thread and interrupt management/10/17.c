...
void main()
{
  ...
  k_thread_create(&thread_data_1, thread_stack_1, STACK_SIZE, thread_entry, (void *)9, NULL, NULL, PRIORITY, 0, K_NO_WAIT);

  k_thread_create(&thread_data_2, thread_stack_2, STACK_SIZE, thread_entry, (void *)6, NULL, NULL, PRIORITY, 0, K_NO_WAIT);

  k_thread_create(&thread_data_3, thread_stack_3, STACK_SIZE, thread_entry, (void *)3, NULL, NULL, PRIORITY, 0, K_NO_WAIT);
